      ...
      <div className="w-full flex flex-col-reverse md:flex-row gap-10 items-center p-5">
        <div className="w-full md:2/3 2xl:w-2/4">
          ...
          <p className="text-justify leading-7">
            ...
            fit. Founded by Shanthi, our platform offers a seamless and
            ...
            the ideal candidate can be challenging, and that's why we've
            dedicated ourselves to creating a user-friendly environment that
            simplifies the process for both parties. Whether you're looking to
